...
import { apiGetTopGamesStatZip, apiGetSportsShortZip, apiGetTopChampsZip, apiGet1x2_VZip, apiGetChampZip, apiCinema, } from "./helabetClient.js";
...
if (process.env.NODE_ENV !== "test") {
    ...
    void (async () => {
        try {
            ...
            console.warn("[helabet session] Warmup failed", error?.message ?? String(error));
        }
    })();
